...
export const TYPE = {
  light: 'font-open-sauce-light',
  normal: 'font-open-sauce-medium',
  medium: 'font-open-sauce-regular',
  bold: 'font-open-sauce-semi-bold',
  black: 'font-open-sauce-black',
};
...
export const COLOR = {
  ...
  brown: 'text-brown',
  desolace: 'text-desolace',
  flurries: 'text-flurries',
  frost: 'text-frost',
  rocky: 'text-rocky',
  teal: 'text-teal',
  black: 'text-black',

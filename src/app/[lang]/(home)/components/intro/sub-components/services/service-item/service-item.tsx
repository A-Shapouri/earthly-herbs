...
const ServiceItem = ({ children, subTitle, title }: ServiceItemProps) => {
  return (
    <Div className={'gap-4 items-center group ease-linear transition-all duration-300'}>
      <Div className={classNames(
        'group-hover:scale-125 ease-linear group-hover:bg-black bg-white text-brown scale-100 group-hover:text-white transition-all duration-300 justify-center items-center md:h-[72px] md:w-[72px] h-12 w-14 md:p-0 p-3 rounded-lg md:rounded-2xl',
      )}>

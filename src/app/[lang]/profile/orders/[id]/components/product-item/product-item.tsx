...
const ProductItem = () => {
  return (
    <Div className={'w-full border border-gray-300 p-3 rounded-2xl justify-between'}>
      <Div className={'gap-6'}>
        <Div className={'rounded-xl md:rounded-t-2xl md:h-36 md:w-36 md:min-h-36 md:min-w-36 h-24 w-24 min-h-24 min-w-24 relative'}>
          <Image objectFit={'contain'} fill className={'rounded-xl md:rounded-t-2xl object-contain'} src={ThumbnailImage2} alt={'product'}/>
        </Div>
